...
class OutDiv extends React.Component {
	render(){
		return(
		<div style={OutDivStyle}>
				...
				<p style={{float:"right",color:"darkGray",paddingRight: "86px", marginTop: "0",fontSize:'12px', marginBottom:"0px"}}>{this.props.children[3]}</p>
